...
public class TabView : ContentView, IDisposable
{
    ...
    public static readonly BindableProperty TabStripBackgroundColorProperty =
        BindableProperty.Create(nameof(TabStripBackgroundColor), typeof(Color), typeof(TabView), KnownColor.Default,
    ...
    public static readonly BindableProperty TabStripBorderColorProperty =
        BindableProperty.Create(nameof(TabStripBorderColor), typeof(Color), typeof(TabView), KnownColor.Default,
    ...
    public static readonly BindableProperty TabContentBackgroundColorProperty =
        BindableProperty.Create(nameof(TabContentBackgroundColor), typeof(Color), typeof(TabView), KnownColor.Default,
    ...
    public static readonly BindableProperty TabIndicatorColorProperty =
        BindableProperty.Create(nameof(TabIndicatorColor), typeof(Color), typeof(TabView), KnownColor.Default,
    ...
    void AddTabViewItemToTabStrip(View item, int index = -1)
    {
        ...
        if (index >= 0)
        {
            ...
            for (var i = index; i < tabStripContent.Children.Count; i++)
                Grid.SetColumn((BindableObject)tabStripContent.Children[i], i);
        }
        else
        {
    ...
    void UpdateSelectedIndex(int position, bool hasCurrentItem = false)
    {
        ...
        Device.BeginInvokeOnMainThread(async () =>
        {
            ...
            if (tabStripContent.Children.Count > 0)
                await tabStripContainerScroll.ScrollToAsync((Element)tabStripContent.Children[tabStripIndex], ScrollToPosition.MakeVisible, false);
    ...
    {
        if (TabStripBorderColor == KnownColor.Default)
            return;
    ...
    void UpdateTabIndicatorPosition(int tabViewItemIndex)
    {
        ...
        var currentTabViewItem = tabStripContent.Children[tabViewItemIndex] as View;
