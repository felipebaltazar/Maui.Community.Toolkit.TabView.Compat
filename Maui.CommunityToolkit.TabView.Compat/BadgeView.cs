...
public class BadgeView : BaseTemplatedView<Grid>
{
	...
	public static new BindableProperty BackgroundColorProperty =
		BindableProperty.Create(nameof(BackgroundColor), typeof(Color), typeof(BadgeView), defaultValue: KnownColor.Default,
			propertyChanged: OnLayoutPropertyChanged);
	...
	public static readonly BindableProperty BorderColorProperty =
		BindableProperty.Create(nameof(BorderColor), typeof(Color), typeof(BadgeView), KnownColor.Default,
			propertyChanged: OnLayoutPropertyChanged);
	...
	public static BindableProperty TextColorProperty =
		BindableProperty.Create(nameof(TextColor), typeof(Color), typeof(BadgeView), defaultValue: KnownColor.Default,
			propertyChanged: OnLayoutPropertyChanged);
