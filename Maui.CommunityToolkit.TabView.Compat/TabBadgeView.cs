...
public class TabBadgeView : TemplatedView
{
    ...
    public static new BindableProperty BackgroundColorProperty =
        BindableProperty.Create(nameof(BackgroundColor), typeof(Color), typeof(TabBadgeView), defaultValue: KnownColor.Default,
    ...
    public static BindableProperty BorderColorProperty =
      BindableProperty.Create(nameof(BorderColor), typeof(Color), typeof(TabBadgeView), defaultValue: KnownColor.Default,
    ...
    public static BindableProperty TextColorProperty =
        BindableProperty.Create(nameof(TextColor), typeof(Color), typeof(TabBadgeView), defaultValue: KnownColor.Default,
