...
public class TabViewItem : TemplatedView
{
    ...
    public static readonly BindableProperty TextColorProperty =
        BindableProperty.Create(nameof(TextColor), typeof(Color), typeof(TabViewItem), KnownColor.Default,
    ...
    public static readonly BindableProperty TextColorSelectedProperty =
        BindableProperty.Create(nameof(TextColorSelected), typeof(Color), typeof(TabViewItem), KnownColor.Default);
    ...
    public static readonly BindableProperty BadgeTextColorProperty =
        BindableProperty.Create(nameof(BadgeTextColor), typeof(Color), typeof(TabViewItem), KnownColor.Default);
    ...
    public static readonly BindableProperty BadgeBackgroundColorProperty =
        BindableProperty.Create(nameof(BadgeBackgroundColor), typeof(Color), typeof(TabViewItem), KnownColor.Default,
            propertyChanged: OnTabViewItemPropertyChanged);
    ...
    public static readonly BindableProperty BadgeBackgroundColorSelectedProperty =
        BindableProperty.Create(nameof(BadgeBackgroundColorSelected), typeof(Color), typeof(TabViewItem), KnownColor.Default,
            propertyChanged: OnTabViewItemPropertyChanged);
    ...
    public static readonly BindableProperty BadgeBorderColorProperty =
       BindableProperty.Create(nameof(BadgeBorderColor), typeof(Color), typeof(TabViewItem), KnownColor.Default,
           propertyChanged: OnTabViewItemPropertyChanged);
    ...
    public static readonly BindableProperty BadgeBorderColorSelectedProperty =
        BindableProperty.Create(nameof(BadgeBorderColorSelected), typeof(Color), typeof(TabViewItem), KnownColor.Default,
            propertyChanged: OnTabViewItemPropertyChanged);
    ...
    internal static readonly BindablePropertyKey CurrentTextColorPropertyKey = BindableProperty.CreateReadOnly(nameof(CurrentTextColor), typeof(Color), typeof(TabViewItem), KnownColor.Default);
    ...
    internal static readonly BindablePropertyKey CurrentBadgeBackgroundColorPropertyKey = BindableProperty.CreateReadOnly(nameof(CurrentBadgeBackgroundColor), typeof(Color), typeof(TabViewItem), KnownColor.Default);
    ...
    internal static readonly BindablePropertyKey CurrentBadgeBorderColorPropertyKey = BindableProperty.CreateReadOnly(nameof(CurrentBadgeBorderColor), typeof(Color), typeof(TabViewItem), KnownColor.Default);
    ...
    void UpdateCurrent()
    {
        CurrentTextColor = !IsSelected || TextColorSelected == KnownColor.Default ? TextColor : TextColorSelected;
        ...
        CurrentBadgeBackgroundColor = !IsSelected || BadgeBackgroundColorSelected == KnownColor.Default ? BadgeBackgroundColor : BadgeBackgroundColorSelected;
        CurrentBadgeBorderColor = !IsSelected || BadgeBorderColorSelected == KnownColor.Default ? BadgeBorderColor : BadgeBorderColorSelected;
